...
const PersonalizedServices = () => {
  return (
    <section className="flex min-h-screen w-full flex-col-reverse md:flex-row relative overflow-hidden p-0 md:p-20 md:pr-40">
      {/* Content Section */}
      <div className="flex flex-1 flex items-center justify-center p-4 md:p-8 relative z-10">
        <div className="max-w-lg text-left">
          ...
          <p className="text-sm md:text-xl text-gray-50 mb-10 font-normal">
